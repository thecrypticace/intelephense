...
class DefinitionProvider {
    ...
    _scopedMemberName(traverser, context) {
        ...
        let typeNames = typeString_1.TypeString.atomicClassArray(context.resolveExpressionType(parent.scope));
        let pred = (x) => {
    ...
    _memberName(traverser, context) {
        ...
        let typeNames = typeString_1.TypeString.atomicClassArray(context.resolveExpressionType(parent.variable));
