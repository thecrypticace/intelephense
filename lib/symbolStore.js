...
class SymbolTable {
    ...
    static create(parsedDocument, externalOnly) {
        ...
        return new SymbolTable(parsedDocument.uri, { kind: 0 /* None */, name: '', children: symbolReader.symbols });
    }
...
class ScopeVisitor {
    constructor(pos, defaultScope, absolute) {
        this.pos = pos;
        this.haltTraverse = false;
        this._kindMask = 1 /* Class */ | 2 /* Interface */ | 4 /* Trait */ | 64 /* Function */ | 32 /* Method */;
    ...
    preorder(node, spine) {
        ...
        if ((node.kind & this._kindMask) > 0 &&
            ...
            (!this._absolute || !(node.modifiers & 512 /* Anonymous */))) {
            this._scope = node;
        }
        return true;
    }
