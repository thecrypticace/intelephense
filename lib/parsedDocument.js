...
(function (ParsedDocument) {
    ...
    function isFixedMemberName(phrase) {
        return ParsedDocument.isPhrase(phrase, [109 /* MemberName */]) &&
    ...
    function isFixedSimpleVariable(phrase) {
        return ParsedDocument.isPhrase(phrase, [154 /* SimpleVariable */]) &&
    ...
    function isFixedScopedMemberName(phrase) {
        return ParsedDocument.isPhrase(phrase, [149 /* ScopedMemberName */]) &&
            (ParsedDocument.isToken(phrase.name, [84 /* VariableName */]) ||
                ParsedDocument.isPhrase(phrase.name, [93 /* Identifier */]));
    }
