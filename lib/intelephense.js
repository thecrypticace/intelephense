...
const builtInSymbolsJson = require("json!./builtInSymbols.json");
var Intelephense;
(function (Intelephense) {
    ...
    function initialise() {
        let builtInSymbols = JSON.parse(builtInSymbolsJson);
        let table = new symbol_1.SymbolTable('\\', { kind: 0, name: '', children: builtInSymbols });
