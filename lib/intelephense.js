...
(function (Intelephense) {
    ...
    function initialise(options) {
        ...
        symbolCache = cache_1.createCache(path.join(storagePath, 'symbols'));
        refCache = cache_1.createCache(path.join(storagePath, 'references'));
        stateCache = cache_1.createCache(path.join(storagePath, 'state'));
