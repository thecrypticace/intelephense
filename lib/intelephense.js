...
(function (Intelephense) {
    ...
    let nameTextEditProvider = new commands_1.NameTextEditProvider(symbolStore, documentStore);
    let referenceProvider = new referenceProvider_1.ReferenceProvider(documentStore, symbolStore);
    let unsubscribeMap = {};
    ...
    function openDocument(textDocument) {
        ...
        referenceReader_1.ReferenceReader.discoverReferences(parsedDocument, symbolTable, symbolStore);
