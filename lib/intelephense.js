...
(function (Intelephense) {
    ...
    function initialise() {
        ...
        symbolStore = new symbol_1.SymbolStore();
    ...
    function discover(textDocument) {
        ...
        const ignore = [
            113 /* MethodDeclarationBody */, 86 /* FunctionDeclarationBody */
        ];
        let text = textDocument.text;
        let parsedDocument = new parsedDocument_1.ParsedDocument(uri, text);
        let symbolTable = symbol_1.SymbolTable.create(parsedDocument, ignore);
