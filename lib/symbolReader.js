...
class SymbolReader extends parsedDocumentVisitor_1.ParsedDocumentVisitor {
        ...
        switch (node.phraseType) {
            ...
            case 123 /* NamespaceUseDeclaration */:
                [this.namespaceUseDeclarationKind, this.namespaceUseDeclarationPrefix] =
                    this._namespaceUseDeclaration(node);
                return true;
            ...
            case 20 /* CatchClause */:
                s = {
                    kind: 256 /* Variable */,
                    name: this._nodeText(node.variable),
                    location: this._nodeLocation(node.variable)
                };
