...
class SymbolReader {
    ...
    get symbols() {
        return this._transformStack[0].symbols;
    }
    preorder(node, spine) {
        let s;
        ...
        switch (node.phraseType) {
            ...
            case 125 /* NamespaceUseGroupClause */:
                {
                    let t = new NamespaceUseClauseTransform(node.phraseType, this.document.nodeLocation(node));
                    this._transformStack.push(t);
                    this.nameResolver.rules.push(t.symbol);
                }
                break;
            case 43 /* ConstElement */:
                this._transformStack.push(new ConstElementTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            case 86 /* FunctionDeclaration */:
                this._transformStack.push(new FunctionDeclarationTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            ...
            case 129 /* ParameterDeclaration */:
                this._transformStack.push(new ParameterDeclarationTransform(this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            ...
            case 28 /* ClassDeclaration */:
                {
                    let t = new ClassDeclarationTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation);
                    this._transformStack.push(t);
            ...
            case 103 /* InterfaceDeclaration */:
                {
                    let t = new InterfaceDeclarationTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation);
                    this._transformStack.push(t);
                    this.nameResolver.pushClass(t.symbol);
                }
                break;
            ...
            case 165 /* TraitDeclaration */:
                this._transformStack.push(new TraitDeclarationTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            ...
            case 26 /* ClassConstElement */:
                this._transformStack.push(new ClassConstantElementTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            ...
            case 138 /* PropertyElement */:
                this._transformStack.push(new PropertyElementTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            ...
            case 113 /* MethodDeclaration */:
                this._transformStack.push(new MethodDeclarationTransform(this.nameResolver, this.document.nodeLocation(node), this.lastPhpDoc, this.lastPhpDocLocation));
                break;
            case 115 /* MethodDeclarationHeader */:
                this._transformStack.push(new MethodDeclarationHeaderTransform());
                break;
            case 95 /* Identifier */:
                if (parentNode.phraseType === 115 /* MethodDeclarationHeader */) {
            ...
            case 2 /* AnonymousClassDeclaration */:
                {
                    let t = new AnonymousClassDeclarationTransform(this.document.nodeLocation(node), this.document.createAnonymousName(node));
                    this._transformStack.push(t);
                    this.nameResolver.pushClass(t.symbol);
                }
                break;
            ...
            case 4 /* AnonymousFunctionCreationExpression */:
                this._transformStack.push(new AnonymousFunctionCreationExpressionTransform(this.document.nodeLocation(node), this.document.createAnonymousName(node)));
                break;
            ...
            case undefined:
                ...
                if (node.tokenType === 160 /* DocumentComment */) {
                    ...
                    //catch clause vars
                    parentTransform.push(new CatchClauseVariableNameTransform(this.document.tokenText(node), this.document.nodeLocation(node)));
                }
...
class ParameterDeclarationTransform {
    constructor(location, doc, docLocation) {
...
class AnonymousFunctionCreationExpressionTransform {
    ...
    push(transform) {
        if (transform.phraseType === 5 /* AnonymousFunctionHeader */) {
            ...
            UniqueSymbolCollection.prototype.push.apply(this._children, transform.uses);
            this._symbol.type = transform.returnType;
        }
        else if (transform.phraseType === 87 /* FunctionDeclarationBody */) {
            UniqueSymbolCollection.prototype.push.apply(this._children, transform.symbols);
        }
    }
    get symbol() {
...
class NamespaceDefinitionTransform {
    constructor(location) {
        ...
        this.symbol = symbol_1.PhpSymbol.create(512 /* Namespace */, '', location);
    }
    push(transform) {
        if (transform.phraseType === 121 /* NamespaceName */) {
            this.symbol.name = transform.text;
