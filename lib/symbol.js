...
class NameResolver {
    ...
    namePhraseToFqn(node, kind) {
        if (!parsedDocument_1.ParsedDocument.isPhrase(node, [
            83 /* FullyQualifiedName */, 142 /* RelativeQualifiedName */, 139 /* QualifiedName */
        ])) {
            return '';
        }
...
class SymbolReader {
    ...
    _shouldReadVar(spine) {
        for (let n = spine.length - 1, c = 0; n >= 0; --n, ++c) {
            if (SymbolReader._varAncestors.indexOf(spine[n].phraseType)) {
                return true;
            }
            else if (c > 3) {
    ...
    namespaceUseDeclaration(node) {
        return [
            ...
            node.prefix ? this.parsedDocument.nodeText(node.prefix, [161 /* Whitespace */]) : null
        ];
    }
...
SymbolReader._varAncestors = [
    106 /* ListIntrinsic */, 76 /* ForeachKey */, 78 /* ForeachValue */,
    16 /* ByRefAssignmentExpression */, 38 /* CompoundAssignmentExpression */,
    153 /* SimpleAssignmentExpression */
];
