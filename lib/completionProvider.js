...
class NameCompletion {
    ...
    completions(context) {
        ...
        if (qNameNode.phraseType === 140 /* QualifiedName */) {
            ...
            if (qNameParent.phraseType === 156 /* StatementList */) {
...
class ScopedAccessCompletion {
    constructor(symbolStore, maxItems) {
        this.symbolStore = symbolStore;
        this.maxItems = maxItems;
    }
    canSuggest(context) {
