...
class ClassInterfaceDeclarationHeaderCompletion {
    canSuggest(context) {
        return parsedDocument_1.ParsedDocument.isToken(context.token, [83 /* Name */]) &&
    ...
    _isClassOrInterfaceDeclarationHeader(node) {
        return node.phraseType === 30 /* ClassDeclarationHeader */ ||
            node.phraseType === 104 /* InterfaceDeclarationHeader */;
    }
}
