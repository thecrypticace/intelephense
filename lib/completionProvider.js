...
function insertText(s, nsName, namePhraseType) {
...
function toNameCompletionItem(s, insertText) {
    switch (s.kind) {
        case 1 /* Class */:
        case 2 /* Interface */:
...
function toFunctionCompletionItem(s, insertText) {
    let item = {
...
function toConstantCompletionItem(s, insertText) {
    let item = {
        kind: lsp.CompletionItemKind.Value,
        label: symbol_1.PhpSymbol.notFqn(s),
        documentation: s.description,
...
function toConstructorCompletionItem(s, insertText) {
    let item = {
