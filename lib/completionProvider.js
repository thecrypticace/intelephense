...
class ExtendsImplementsKeywordCompletion {
    canSuggest(context) {
...
ExtendsImplementsKeywordCompletion._isClassHeaderRegex = /class\s+\w+\s+.$/;
ExtendsImplementsKeywordCompletion._isInterfaceHeaderRegex = /interface\s+\w+\s+.$/;
